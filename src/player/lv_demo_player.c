...
#if LV_DEMO_PLAYER_AUTO_PLAY && LV_USE_PERF_MONITOR
...
void lv_demo_player(void)
{
    ...
    ctrl = lv_demo_player_main_create(lv_screen_active());
...
#endif /*LV_DEMO_PLAYER_AUTO_PLAY*/
