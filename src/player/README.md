...
- In `lv_conf.h` or equivalent places set `LV_USE_DEMO_PLAYER 1`
- With `LV_DEMO_PLAYER_AUTO_PLAY` enabled a ~60 sec demo will be played.
- After `lv_init()` and initializing the drivers call `lv_demo_player()`
